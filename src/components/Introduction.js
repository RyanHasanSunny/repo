...
import sideimg from '../assets/sunny.jpg'; // Assuming this image is your side image
import bgimg from '../assets/r0004.png'; // Assuming this image is your side image
const Introduction = () => {
  return (
      ...
      <div className="bgimg">
        ...
        <div className="img">
          ...
          <div className="text-content">
            ...
            <a href="#connect" className="download-btn">Download CV</a>
            </div>
          </div>
